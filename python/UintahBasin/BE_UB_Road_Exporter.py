# -*- coding: utf-8 -*-
"""
Created on Fri Mar 3 14:49:21 2023
@author: eneemann
Script to export SGID roads for BoxElder and UintahBasin

3 Mar 2023: Created initial version of code (EMN).
"""
...
streets_schema = os.path.join(schema_db, "Streets_Combined")
working_roads = os.path.join(staging_db, f"BE_UB_streets_build_{today}")
...
def export_from_sgid():
    # Export roads from SGID into new FC based on intersection with citycodes boundary
    ...
    where_SGID = """COUNTY_L IN ('49003', '49057', '49011', '49045', '49005', '49043', '49009', '49051', '49013', '49047', '49007', '49015', '49019') OR 
    COUNTY_R IN ('49003', '49057', '49011', '49045', '49005', '49043', '49009', '49051', '49013', '49047', '49007', '49015', '49019')"""
    ...
    print("Selecting SGID roads to export by intersection with 10-mile citycode buffer ...")
    arcpy.management.SelectLayerByLocation("sgid_roads_lyr", "HAVE_THEIR_CENTER_IN", citycodes, "10 Miles")
...
def load_into_schema():
    if arcpy.Exists(working_roads):
        arcpy.management.Delete(working_roads)
    ...
    print('Appending SGID roads into DPS Geovalidation schema ...')
