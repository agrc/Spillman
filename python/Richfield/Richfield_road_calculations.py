...
18 Feb 2020 - script to calculate street fields
"""
...
fc_layer = "streets_update_20230515"    # Update to working streets fc
...
def blanks_to_nulls(streets):
    ...
    flist = ['OBJECTID', 'PREDIR', 'STREETNAME', 'STREETTYPE', 'SUFDIR', 'ALIAS1', 'ALIAS1TYPE', 'ALIAS2', 'ALIAS2TYPE',
              ...
              'DOT_RTPART', 'CLASS', 'SOURCE', 'NOTES', 'STATUS', 'ACCESS']
