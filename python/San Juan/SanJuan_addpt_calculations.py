# -*- coding: utf-8 -*-
"""
Created on Mon Mar 22 09:34:29 2021

@author: eneemann

EMN: Initial script to calculate address point fields for San Juan
"""
...
def blanks_to_nulls(pts):
    ...
    flist = ['OBJECTID', 'AddNumSuffix', 'PrefixDir', 'StreetName', 'StreetType', 'SuffixDir', 'UnitType', 'UnitID',
             'City', 'ZipCode', 'CountyID', 'PtLocation', 'PtType', 'Structure', 'ParcelID', 'AddSource',
             'LoadDate', 'Status', 'Editor', 'ModifyDate', 'CityCode', 'Location', 'ACSNAME', 'ACSSUF',
             'NeedsAttn', 'Label', 'ACSALIAS', 'CommonName', 'Base']
