...
fc = os.path.join(toc_db, r'CommonNames')
fc_working = os.path.join(toc_db, f'CommonNames_errors_{today}')
fc_final_name = f'CommonNames_errors_only_{today}'
...
# skip_fields = ['Error_UGRC', 'ParcelID']        # for AddressPoints
