...
EMN: Initial script to calculate commonplace fields for Salt Lake CC
"""
...
# stage_db = r"C:\E911\TOC\TOC_Staging.gdb"
...
def calc_all_components_from_street(pts):
    ...
    #            0           1           2           3           4
    fields = ['Street', 'ADDR_SN', 'ADDR_PD', 'ADDR_ST', 'ADDR_SD']
    # where_clause = "Street IS NOT NULL AND ADDR_SN IS NULL"
    ...
    print("Total count of ADDR_SN calculations is: {}".format(update_count))
