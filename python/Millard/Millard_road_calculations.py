# -*- coding: utf-8 -*-
"""
Created on Tue Sep 20 10:28:56 2020
@author: eneemann

20 Sep 2022 - script to calculate street fields
"""
...
fc_layer = "Millard_Streets_update_20220919"    # Update to working streets fc
...
def blanks_to_nulls(streets):
    ...
    flist = ['OBJECTID', 'PREDIR', 'FULLNAME', 'STREETNAME', 'STREETTYPE', 'SUFDIR', 'ALIAS1', 'ALIAS1TYPE', 'ALIAS2', 'ALIAS2TYPE',
              'ACSALIAS', 'ACSNAME', 'ACSSUF', 'SALIAS1', 'SALIAS2', 'SALIAS3', 'SALIAS4', 'HWYNAME']
