...
#    addpt_fields = ['OBJECTID', 'AddNum', 'Street', 'Notes']
    ...
    path = r'C:\E911\MillardCo\Addpts_working_folder\millard_neartable_join1.csv'
    ...
    path = r'C:\E911\MillardCo\Addpts_working_folder\millard_neartable_join2.csv'
    ...
    path = r'C:\E911\MillardCo\Addpts_working_folder\neartable_updated.csv'
...
#    test_df.to_csv(r'C:\E911\MillardCo\Addpts_working_folder\millard_neartable_test_edit.csv')
    ...
    join_path = r'C:\E911\MillardCo\Addpts_working_folder\millard_neartable_join.csv'
