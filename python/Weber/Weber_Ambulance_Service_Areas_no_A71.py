# -*- coding: utf-8 -*-
"""
Created on Thu Aug 20 15:18:21 2020
@author: eneemann
Script to build Ambulance Service Areas for Weber Area Dispatch
"""
...
working_db = os.path.join(weber_staging,'Ambulance_Service_Areas_A71_' + today +  '.gdb')
...
arcpy.CreateFileGDB_management(weber_staging, 'Ambulance_Service_Areas_A71_' + today +  '.gdb')
...
facilities = os.path.join(staging_db, "Ambulance_Weber_Morgan_no_A71")
...
arcpy.conversion.FeatureClassToFeatureClass(r"AmbulanceServiceAreas\Polygons", staging_db, "AmbulanceServiceArea_Polygons_A71")
live_sa = os.path.join(staging_db, "AmbulanceServiceArea_Polygons_A71")
