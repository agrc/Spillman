...
stgeorge_addpts = "StG_AddPts_update_20230523"    # Point to current addpts in staging_db
...
check_nearby_roads(working_addpts, stgeorge_streets, staging_db)
...
df = pd.read_csv(r'C:\E911\StGeorgeDispatch\Addpts_working_folder\stgeorge_neartable_final.csv')
